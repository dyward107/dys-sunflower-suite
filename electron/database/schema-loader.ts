...
export class SchemaLoader {
  ...
  static loadSchemas(): { 
    ...
    try {
      ...
      // Combine schemas in dependency order (Module A first, then B, then SU)
      const combined = [
      ...
      console.error('❌ Failed to load schema files:', error.message);
  ...
  static validateSchemaFiles(): boolean {
    ...
    try {
      ...
      console.log('✅ All schema files found');
      return true;
      
    } catch (error: any) {
      console.error('❌ Error validating schema files:', error.message);
      return false;
    }
  }
}
